...
__skim_history__() {
  ...
  output=$(
    builtin fc -lnr -2147483648 |
      ...
      sort -k1,1nr |
      SKIM_DEFAULT_OPTIONS="--height ${SKIM_TMUX_HEIGHT:-40%} $SKIM_DEFAULT_OPTIONS -n2..,.. --bind=ctrl-r:toggle-sort --no-sort $SKIM_CTRL_R_OPTS --no-multi --read0" $(__skimcmd) --query "$READLINE_LINE"
  ) || return
